...
const NotFound = () => {
    ...
    return (
        ...
        <div className="  mt-15.5 flex flex-col items-center justify-center text-sm h-[400px]   bg-gray-50   ">
            <p className="font-medium text-lg text-indigo-500 mt-3">404 Error</p>
